...
$string['featuredcourseswidget_desc'] = 'Mostra uma secção onde são apresentadas as disciplinas destacadas em formato de cartões, num layout de 3 colunas. Por omissão, são obtidas as disciplinas visíveis que têm data de início no futuro. Ajuste as configurações abaixo para alterar esse comportamento.';
$string['featuredcourseswidgetheading'] = 'Widget de disciplinas em destque';
$string['fonts'] = 'Tipo de letra';
...
$string['disablesocialmedia'] = 'Desativar ícones de redes sociais';
$string['disablesocialmedia_desc'] = 'Oculta completamente a linha de ícones de redes sociais no rodapé. Cada ícone também é ocultado automaticamente quando o campo de URL correspondente está vazio.';
$string['frontendby'] = 'Danka Treinamentos';
$string['frontpagestream'] = 'Opções página inicial';
$string['fullwidthpage'] = 'Largura total';
$string['fullwidthpage_desc'] = 'Aplica largura total em todas as páginas. Se desativado, aplica-se o comportamento padrão do Boost.';
...
$string['featuredcourseshidden'] = 'Mostrar disciplinas ocultas';
$string['featuredcourseshidden_desc'] = 'Se ativado, a consulta devolve também as disciplinas ocultas.';
$string['featuredcategoriessubtitle'] = 'Subtítulo do widget de categorias';
$string['featuredcategoriessubtitle_desc'] = 'Texto simples para usar como subtítulo do widget. Não mostrará nada se o campo estiver vazio.';
$string['courseindexheading'] = 'Mostrar informação extra no índice do curso.';
$string['courseindexheading_desc'] = 'Apresenta o nome completo ou abreviado do curso como cabeçalho no índice do curso.';
